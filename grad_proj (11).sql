...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2025 at 06:49 PM
...
(4, 4, 'meeting room', 20, 'meeting', 'active', 'default.png'),
(5, 4, 'shared area', 40, 'shared', 'active', 'default.png');
...
(4, 3, 'creative workspace', 'giza,dokki,msa7a', 'this for all employees to work', NULL, 1, '2025-03-12 19:11:29');
...
--
ALTER TABLE `workspaces`
  MODIFY `workspace_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `amenities`
  ADD CONSTRAINT `amenities_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`room_id`);
